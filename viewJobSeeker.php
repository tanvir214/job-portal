                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editUser.php?userId=<?php echo $uName; ?>&tableName=jobseeker" class="btn btn-outline-primary m-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <a href="deleteUser.php?userId=<?php echo $uName ?>&tableName=jobseeker" class="btn btn-outline-danger m-1"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>        
                            <?php 
                                    }  
