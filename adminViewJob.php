                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td scope="col" class="font-weight-bold text-center">Post By</td>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="fw-normal"><?php echo $jobEmp ?></td>
                                        <td>
                                            ...
                                            <a href="application.php?jobId=<?php echo $jobId; ?>" class="btn btn-outline-info m-1"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>        
                            <?php 
                                    }  
